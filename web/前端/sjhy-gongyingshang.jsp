    ...
    <div class="container">
     <!-- 面包屑导航 -->
        <div class="bread-crumbs">
            ...
            <span><i class="fa fa-angle-double-right"></i></span>
            <a href="javascript:;" class="selected">升级供应商</a>
        </div>
        <!-- 会员左侧 -->
         ...
         <div class="member-right">
            <div class="member-main">
                <div class="member-column">
                    <div class="member-tit"><p>升级供应商</p></div>
                     <div class="member-con">
                        <div class="attest">
                            <a href="javascript:;" class="attest01">
                               <img src="images/upgrade-icon05.png" alt="">
                           </a>
                           <a href="javascript:;" class="attest02">
                               <img src="images/upgrade-icon06.png" alt="">
                           </a>
                        </div>
                     </div>
                </div>
